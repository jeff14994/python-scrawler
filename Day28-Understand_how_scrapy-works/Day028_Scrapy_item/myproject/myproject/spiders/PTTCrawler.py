...
# 範例目標網址: https://www.ptt.cc/bbs/movie/M.1609255595.A.50A.htm
# 從 scrapy/Spiders/__init__.py 繼承 Spider 
class PttcrawlerSpider(scrapy.Spider):
    name = 'PTTCrawler'
    allowed_domains = ['www.ptt.cc']
    start_urls = ['https://www.ptt.cc/bbs/movie/M.1609255595.A.50A.html', 'https://www.ptt.cc/bbs/movie/M.1609257932.A.2ED.html']
    cookies = {'over18': '1'}

    def start_requests(self):
        # start_quests 若要使用 scrapy.Spider 的變數，需要用 self.start_urls 來取用
